...
<div class="register-box">
    <div class="register-logo">
        <a href="${pageContext.request.contextPath }/"><b>Instagram</b></a>
    </div>
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="${pageContext.request.contextPath }/register" modelAttribute="user" method="POST>
                ...
                <div class="input-group mb-3">
                    <input path="email" name="email" type="email" class="form-control" placeholder="Email">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <div class="input-group mb-3">
                    <input path="username" name="username" type="username" class="form-control" placeholder="Username">
                    <div class="input-group-append">
                        <div class="input-group-text">
