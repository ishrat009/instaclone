package com.instagram.config.persistence;
...
@EnableJpaRepositories("com.instagram.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.instagram.model");
                for (Class<?> clazz : (new Reflections("com.instagram.model")).getTypesAnnotatedWith(Entity.class)) {
